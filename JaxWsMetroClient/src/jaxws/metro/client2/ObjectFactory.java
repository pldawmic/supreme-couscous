 ...
 * generated in the jaxws.metro.client2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _NextNResponse_QNAME = new QName("http://example1.jaxws/", "nextNResponse");
    private final static QName _Next1Response_QNAME = new QName("http://example1.jaxws/", "next1Response");
    private final static QName _NextN_QNAME = new QName("http://example1.jaxws/", "nextN");
    private final static QName _Next1_QNAME = new QName("http://example1.jaxws/", "next1");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jaxws.metro.client2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example1.jaxws/", name = "nextNResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example1.jaxws/", name = "next1Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example1.jaxws/", name = "nextN")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://example1.jaxws/", name = "next1")
