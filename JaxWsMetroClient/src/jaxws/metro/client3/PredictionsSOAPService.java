 ...
 * 
 */
@WebServiceClient(name = "PredictionsSOAPService", targetNamespace = "http://example2.jaxws/", wsdlLocation = "http://localhost:8080/JaxWsMetroWebApp/prediction?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PREDICTIONSSOAPSERVICE_QNAME = new QName("http://example2.jaxws/", "PredictionsSOAPService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JaxWsMetroWebApp/prediction?wsdl");
    ...
    public PredictionsSOAP getPredictionsSOAPPort() {
        return super.getPort(new QName("http://example2.jaxws/", "PredictionsSOAPPort"), PredictionsSOAP.class);
    }
    ...
    public PredictionsSOAP getPredictionsSOAPPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example2.jaxws/", "PredictionsSOAPPort"), PredictionsSOAP.class, features);
    }
